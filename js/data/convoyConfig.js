...
/**
 * `tag` : nom COURT affiché sur la coque dans la zone de jeu. Signalé en partie
 * test : « on ne sait pas quel navire est qui dans la zone de jeu ». Les six
 * silhouettes sont distinctes, mais savoir laquelle est la citerne — donc laquelle
 * conditionne le calcul forcé — demandait de les avoir mémorisées.
 */
export const TRANSPORT_TYPES = {
  ...
  liner: {
    id: 'liner', name: 'Paquebot Cloud 9', souls: 20400, kind: 'liner', role: 'souls', tag: 'PAQUEBOT',
  ...
  tanker: {
    id: 'tanker', name: 'Citerne à tylium', souls: 2600, kind: 'tanker', role: 'fuel', tag: 'CITERNE',
  ...
  freighter: {
    id: 'freighter', name: 'Cargo lourd', souls: 4800, kind: 'freighter', role: 'parts', tag: 'CARGO',
  ...
  hospital: {
    id: 'hospital', name: 'Navire-hôpital', souls: 9200, kind: 'hospital', role: 'infirmary', tag: 'HÔPITAL',
  ...
  tug: {
    id: 'tug', name: 'Remorqueur', souls: 900, kind: 'tug', role: 'workshop', tag: 'REMORQUEUR',
  ...
  ferry: {
    id: 'ferry', name: 'Transport Gemenon', souls: 12100, kind: 'ferry', role: 'souls', tag: 'TRANSPORT',
